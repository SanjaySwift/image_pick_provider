class QueryAutocompleteModel {
  QueryAutocompleteModel({
  ...
  QueryAutocompleteModel.fromJson(dynamic json) {
  ...
  String? _status;
QueryAutocompleteModel copyWith({  List<Predictions>? predictions,
  String? status,
}) => QueryAutocompleteModel(  predictions: predictions ?? _predictions,
...
StructuredFormatting copyWith({  String? mainText,
  ...
  secondaryTextMatchedSubstrings: secondaryTextMatchedSubstrings ?? _secondaryTextMatchedSubstrings,
);
...
class SecondaryTextMatchedSubstrings {
  ...
  num? _length;
  num? _offset;
SecondaryTextMatchedSubstrings copyWith({  num? length,
  num? offset,
}) => SecondaryTextMatchedSubstrings(  length: length ?? _length,
